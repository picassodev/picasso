...
and grid-to-particle (G2P) updates, embedded free surface tracking, and robust
...
and related complex particle operations [@apic, @polypic] used for fluid and solid mechanics.
...
field, e.g. @powerpic, @ipic. Extensions to Picasso for plasma physics and cosmology will require further integrations
with the Cabana library fast Fourier transform and structured solver interfaces for electric and magnetic field support.
